...
<?php
	...
	$requete2 = "SELECT SUM(Quantite) FROM fourniture INNER JOIN professeur ON fourniture.IDProfesseur = professeur.IDProfesseur WHERE Matiere='Mathématiques'";
    $result2=$conn->query($requete2);
	$result2=mysqli_fetch_array($result2);
	$requete3 = "SELECT SUM(Quantite) FROM fourniture INNER JOIN professeur ON fourniture.IDProfesseur = professeur.IDProfesseur WHERE Matiere='Communication'";
...
$resultTotal[0]=$result1[0]+$result2[0]+$result3[0]+$result4[0]+$result6[0];
   ...
   echo " <table class='graph' cellspacing='6' cellpadding='0'>";
     echo "<thead>";
      ...
      echo "<tbody>";
        ...
        echo "</tr>";
        echo "<tr>";
          echo "<td>Mathématiques</td><td class='bar'><div style='width: ".$result2cent."%'></div>".$result2[0]."</td><td>".$result2cent."%</td>";
        echo "</tr>";
        echo "<tr>";
          echo "<td>Communication</td><td class='bar'><div style='width:".$result3cent."%'></div>".$result3[0]."</td><td>".$result3cent."%</td>";
        echo "</tr>";
        echo "<tr>";
